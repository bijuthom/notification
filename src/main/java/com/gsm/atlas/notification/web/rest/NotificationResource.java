...
import com.gsm.atlas.notification.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.gsm.atlas.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
